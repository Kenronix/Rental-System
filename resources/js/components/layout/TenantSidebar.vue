...
const navigationItems = [
  ...
  { name: 'My Rental', icon: BuildingOfficeIcon, path: '/tenant/rental' },
  { name: 'Utilities', icon: BoltIcon, path: '/tenant/utilities' },
  { name: 'Payments', icon: CreditCardIcon, path: '/tenant/payments' },
  { name: 'Reports', icon: ChartBarIcon, path: '/tenant/reports' }
]
